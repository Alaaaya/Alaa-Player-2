...
fun ProviderEntity.toDomain() = Provider(
    ...
    stalkerProtocolPreference = stalkerProtocolPreference,
    stalkerTransportMode = stalkerTransportMode,
    stalkerTransportOrigin = stalkerTransportOrigin,
    stalkerTlsSpkiSha256 = stalkerTlsSpkiSha256,
    stalkerTransportConsentAt = stalkerTransportConsentAt,
    stalkerConfigurationGeneration = stalkerConfigurationGeneration,
    stalkerDiscoverySummary = stalkerDiscoverySummary,
    stalkerCapabilitiesJson = stalkerCapabilitiesJson,
    stalkerRequestedProfileId = stalkerRequestedProfileId,
    stalkerLearnedProfileId = stalkerLearnedProfileId,
    stalkerProfileRevision = stalkerProfileRevision,
    stalkerProfileVerification = stalkerProfileVerification,
    stalkerProtocolFamily = stalkerProtocolFamily,
    ...
    stalkerCatalogMode = stalkerCatalogMode,
